...
public class Single_Student_Notification_Adapater extends RecyclerView.Adapter<Single_Student_Notification_Adapater.MyViewHolder> implements Filterable {
    ...
    public Single_Student_Notification_Adapater(List<vehical_Detail_registred_student_model> stud_list, Context context) {
    ...
    @Override
    public Single_Student_Notification_Adapater.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.custom_registred_student, parent, false);

        return new Single_Student_Notification_Adapater.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(final Single_Student_Notification_Adapater.MyViewHolder holder, int position) {
